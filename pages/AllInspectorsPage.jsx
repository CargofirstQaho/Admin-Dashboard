...
export default function AllInspectorsPage({ 
  inspectors, 
  onNavigateToDetail, 
  onNavigateBack,
  sidebarItems,
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">All Inspectors</h1>
              <p className="text-sm text-gray-600 mt-1">View and manage all inspector records</p>
            </div>
          </div>
        </div>
      </header>
